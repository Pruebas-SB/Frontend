    ...
    return (
        <div className='md:flex md:min-h-screen'>
            ...
            <div className='md:w-1/5 bg-gray-800 px-5 py-4'>
                ...
                <h2 className='text-4xl font-black text-center text-slate-200'>QuitoEmprende</h2>

                <img src="https://cdn-icons-png.flaticon.com/512/2103/2103752.png" alt="img-client" className="m-auto mt-8 p-1 border-2 border-slate-500 rounded-full" width={120} height={120} />
