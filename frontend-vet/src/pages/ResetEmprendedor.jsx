...
const ResetEmprendedor = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <ToastContainer />
      <h1 className="text-3xl font-semibold mb-2 text-center text-gray-500">Restablece tu contraseña (Emprendedor)</h1>
...
export default ResetEmprendedor
