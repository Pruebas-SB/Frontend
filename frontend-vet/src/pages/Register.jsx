                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <div className="mt-3 text-sm flex justify-between items-center">
                        ...
                        <div className="flex gap-2">
                            <Link 
                                to="/login" 
                                className="underline text-sm text-gray-400 hover:text-gray-900 ml-[-10px] mt-2"
                            >
                                Regresar
                            </Link>
                            <Link to="/login" className="py-2 px-5 bg-gray-500 text-slate-300 border rounded-xl hover:scale-110 duration-300 hover:bg-gray-900">
                                Iniciar sesión
                            </Link>
                        </div>
                    </div>
